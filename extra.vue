<template>
  <div class="headerTitle">
    ...
    <div class="title-login">
      <img src="./../assets/images/user-login.png" v-if="!this.sysFilePath" @click="test">
    ...
    <remote-js type="text/javascript" src="http://qzonestyle.gtimg.cn/qzone/openapi/qc_loader.js" data-appid="1106576620" charset="utf-8"></remote-js>
  </div>
</template>
